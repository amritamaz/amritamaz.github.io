...
// circle_tick Class
at.bartelme.circle_tick = Class.create();
at.bartelme.circle_tick.prototype = {
	initialize: function()
	{
		// Get elements
		this.interval = 2000;
		this.container = $("circle_tick");
		...
		// this.toggle_button.id = "togglecircle_tick";
...
Event.observe(window, "load", function(){new at.bartelme.circle_tick()}, false);
